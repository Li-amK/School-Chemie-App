    ...
    */
    public void load(android.content.Context r11, int r12) {
        /*
            ...
            r1 = 0
            r6 = 0
            int r3 = r4.getEventType()     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
        L_0x000f:
            ...
            }     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
        L_0x0014:
            int r3 = r4.next()     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            goto L_0x000f
        L_0x0019:
            java.lang.String r1 = r4.getName()     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            goto L_0x0014
        L_0x001e:
            java.lang.String r6 = r4.getName()     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            android.util.AttributeSet r7 = android.util.Xml.asAttributeSet(r4)     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r10.fillFromAttributeList(r11, r7)     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            java.lang.String r7 = "Guideline"
            boolean r7 = r6.equalsIgnoreCase(r7)     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            if (r7 == 0) goto L_0x0035
            r7 = 1
            r0.mIsGuideline = r7     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
        L_0x0035:
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r7 = r10.mConstraints     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            int r8 = r0.mViewId     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            r7.put(r8, r0)     // Catch: XmlPullParserException -> 0x0041, IOException -> 0x0048
            goto L_0x0014
        L_0x0041:
            r2 = move-exception
            r2.printStackTrace()
