        ...
        if (numMatchConstraints <= 0 || numMatchConstraints != numVisibleWidgets) {
            ...
            if (isChainPacked) {
                ...
                while (widget2 != null) {
                    ...
                    if (next2 != null || widget2 == last) {
                        if (orientation == 0) {
                            dimension2 = widget2.getWidth();
                        } else {
                            dimension2 = widget2.getHeight();
                        }
                        float distance3 = distance2 + widget2.mListAnchors[offset].getMargin();
                        ...
                        distance2 = distance3 + dimension2 + widget2.mListAnchors[offset + 1].getMargin();
                    }
                    widget2 = next2;
                }
                ...
                if (isChainSpreadInside && numVisibleWidgets > 1) {
                    distance4 = firstOffset + firstVisibleWidget.mListAnchors[offset].getMargin();
                }
                if (isChainSpread && firstVisibleWidget != null) {
                    distance4 += firstVisibleWidget.mListAnchors[offset].getMargin();
                }
                while (widget3 != null) {
                    if (LinearSystem.sMetrics != null) {
                        LinearSystem.sMetrics.nonresolvedWidgets--;
                    ...
                    if (next3 != null || widget3 == last) {
                        if (orientation == 0) {
                            dimension = widget3.getWidth();
                        } else {
                            dimension = widget3.getHeight();
                        }
                        if (widget3 != firstVisibleWidget) {
                            distance4 += widget3.mListAnchors[offset].getMargin();
                        }
                        ...
                        distance4 += widget3.mListAnchors[offset + 1].getMargin() + dimension;
            ...
            while (widget4 != null) {
                ...
                if (next4 != null || widget4 == last) {
                    float dimension3 = distance5 / numMatchConstraints;
