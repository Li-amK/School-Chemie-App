    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                child2.measure(View.MeasureSpec.makeMeasureSpec((int) (childWidthSize * lp.widthFactor), Declaration.MODULE_REFERENCE), this.mChildHeightMeasureSpec);
            }
        }
    }
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (!lp2.isDecor && (ii = infoForChild(child2)) != null) {
                    ...
                    if (lp2.needsMeasure) {
                        ...
                        child2.measure(View.MeasureSpec.makeMeasureSpec((int) (childWidth * lp2.widthFactor), Declaration.MODULE_REFERENCE), View.MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, Declaration.MODULE_REFERENCE));
                    }
