                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            if (lp2.weight > 0.0f) {
                                ...
                                if (canSlide) {
                                    ...
                                    child2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth + ((int) ((lp2.weight * Math.max(0, widthRemaining)) / weightSum)), Declaration.MODULE_REFERENCE), childHeightSpec);
                                }
                            }
