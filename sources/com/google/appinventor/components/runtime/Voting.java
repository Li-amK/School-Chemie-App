...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    public void postRequestBallot() {
        WebServiceUtil.getInstance().postCommandReturningObject(this.serviceURL, REQUESTBALLOT_COMMAND, null, new AsyncCallbackPair<JSONObject>() { // from class: com.google.appinventor.components.runtime.Voting.2
    ...
    public void postSendBallot(String userChoice, String userId) {
        WebServiceUtil.getInstance().postCommand(this.serviceURL, SENDBALLOT_COMMAND, Lists.newArrayList(new BasicNameValuePair(USER_CHOICE_PARAMETER, userChoice), new BasicNameValuePair(USER_ID_PARAMETER, userId)), new AsyncCallbackPair<String>() { // from class: com.google.appinventor.components.runtime.Voting.4
