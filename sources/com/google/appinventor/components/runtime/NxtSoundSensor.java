...
public class NxtSoundSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    private final Runnable sensorReader = new Runnable() { // from class: com.google.appinventor.components.runtime.NxtSoundSensor.1
    ...
    public LegoMindstormsNxtSensor.SensorValue<Integer> getSoundValue(String functionName) {
        ...
        return (returnPackage == null || !getBooleanValueFromBytes(returnPackage, 4)) ? new LegoMindstormsNxtSensor.SensorValue<>(false, null) : new LegoMindstormsNxtSensor.SensorValue<>(true, Integer.valueOf(getUWORDValueFromBytes(returnPackage, 10)));
    }
