...
public final class Twitter extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    private final List<List<String>> timeline = new ArrayList();
    private final List<String> directMessages = new ArrayList();
    private final List<String> searchResults = new ArrayList();
    private AccessToken accessToken = retrieveAccessToken();
    private final int requestCode = this.form.registerForActivityResult(this);
    ...
    class AnonymousClass7 implements Runnable {
        ...
        public void run() {
            try {
                for (long id : Twitter.this.twitter.getFollowersIDs(-1L).getIDs()) {
