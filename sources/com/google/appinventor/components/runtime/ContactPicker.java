...
public class ContactPicker extends Picker implements ActivityResultListener {
    ...
    protected String getEmailAddress(String emailId) {
        try {
            String data = "";
            Cursor cursor = this.activityContext.getContentResolver().query(Contacts.ContactMethods.CONTENT_EMAIL_URI, new String[]{"data"}, "contact_methods._id = " + Integer.parseInt(emailId), null, null);
            try {
