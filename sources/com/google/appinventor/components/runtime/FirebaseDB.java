...
public class FirebaseDB extends AndroidNonvisibleComponent implements Component {
    ...
    private ChildEventListener childListener = new ChildEventListener() { // from class: com.google.appinventor.components.runtime.FirebaseDB.1
    ...
    private Firebase.AuthStateListener authListener = new Firebase.AuthStateListener() { // from class: com.google.appinventor.components.runtime.FirebaseDB.2
    ...
    public void RemoveFirst(String tag) {
        ...
        firebaseTransaction(new Transactional(null, null, result) { // from class: com.google.appinventor.components.runtime.FirebaseDB.4
                    ...
                    if (value instanceof String) {
                        ...
                        if (!(value2 instanceof List)) {
                            ...
                            try {
                                ...
                                result2 = Transaction.success(currentData);
                            } catch (JSONException e) {
        ...
        }, this.myFirebase.child(tag), new Runnable() { // from class: com.google.appinventor.components.runtime.FirebaseDB.5
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void AppendValue(String tag, final Object valueToAdd) {
        final ReturnVal result = new ReturnVal();
        firebaseTransaction(new Transactional(null, null, result) { // from class: com.google.appinventor.components.runtime.FirebaseDB.7
            @Override // com.google.appinventor.components.runtime.FirebaseDB.Transactional
            Transaction.Result run(MutableData currentData) {
                Transaction.Result result2;
                Object value = currentData.getValue();
