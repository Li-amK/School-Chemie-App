...
public class HoneycombMR1Util {
    ...
    public static Cursor getDataCursor(String id, Activity activityContext, String[] dataProjection) {
        return activityContext.getContentResolver().query(ContactsContract.Data.CONTENT_URI, dataProjection, "contact_id=? AND (mimetype=? OR mimetype=?)", new String[]{id, "vnd.android.cursor.item/phone_v2", "vnd.android.cursor.item/email_v2"}, null);
    }
