...
public class NativeOpenStreetMapController implements MapFactory.MapController, MapListener {
        ...
        if (enabled && this.compass == null) {
            ...
            this.view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.2
                ...
                public boolean onPreDraw() {
                    NativeOpenStreetMapController.this.compass.setCompassCenter((NativeOpenStreetMapController.this.view.getMeasuredWidth() / NativeOpenStreetMapController.this.view.getContext().getResources().getDisplayMetrics().density) - 35.0f, 35.0f);
                    return true;
                }
            });
    ...
    public void addFeature(final MapFactory.MapLineString aiPolyline) {
        ...
        polyline.setOnClickListener(new Polyline.OnClickListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.4
        ...
        polyline.setOnDragListener(new Polyline.OnDragListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.5
            public void onDragStart(Polyline polyline2) {
                for (MapFactory.MapEventListener listener : NativeOpenStreetMapController.this.eventListeners) {
                    listener.onFeatureStartDrag(aiPolyline);
                }
            }

            public void onDrag(Polyline polyline2) {
                for (MapFactory.MapEventListener listener : NativeOpenStreetMapController.this.eventListeners) {
                    listener.onFeatureDrag(aiPolyline);
                }
            }

            public void onDragEnd(Polyline polyline2) {
                aiPolyline.updatePoints(polyline2.getPoints());
                for (MapFactory.MapEventListener listener : NativeOpenStreetMapController.this.eventListeners) {
    ...
    private void getMarkerDrawableRaster(final MapFactory.MapMarker aiMarker, final AsyncCallbackPair<Drawable> callback) {
        MediaUtil.getBitmapDrawableAsync(this.form, aiMarker.ImageAsset(), new AsyncCallbackPair<BitmapDrawable>() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.12
            @Override // com.google.appinventor.components.runtime.util.AsyncCallbackPair
            public void onFailure(String message) {
    ...
    private Drawable rasterizeSVG(MapFactory.MapMarker aiMarker, SVG markerSvg) {
        ...
        SVG.Length strokeWidth = new SVG.Length(aiMarker.StrokeWidth() / ((float) Math.sqrt((scaleH * scaleH) + (scaleW * scaleW))));
    ...
    public static class MultiPolygon extends Polygon {
        ...
        public void setDraggable(boolean draggable) {
            NativeOpenStreetMapController.super.setDraggable(draggable);
