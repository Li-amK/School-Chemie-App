...
public class HoneycombWebViewClient extends FroyoWebViewClient<WebViewer> {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        return (request.getUrl().getAuthority().equals("localhost") || request.getUrl().toString().startsWith(ASSET_PREFIX)) ? handleAppRequest(request.getUrl().toString()) : super.shouldInterceptRequest(view, request);
    }
