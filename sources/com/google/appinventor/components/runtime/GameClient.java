...
public class GameClient extends AndroidNonvisibleComponent implements Component, OnResumeListener, OnStopListener {
    ...
    private List<String> joinedInstances = Lists.newArrayList();
    private List<String> invitedInstances = Lists.newArrayList();
    private List<String> publicInstances = Lists.newArrayList();
    private String serviceUrl = "http://appinvgameserver.appspot.com";
    ...
    public void postMakeNewInstance(String requestedInstanceId, Boolean makePublic) {
        postCommandToGameServer(NEW_INSTANCE_COMMAND, Lists.newArrayList(new BasicNameValuePair(PLAYER_ID_KEY, UserEmailAddress()), new BasicNameValuePair(GAME_ID_KEY, GameId()), new BasicNameValuePair(INSTANCE_ID_KEY, requestedInstanceId), new BasicNameValuePair(INSTANCE_PUBLIC_KEY, makePublic.toString())), new AsyncCallbackPair<JSONObject>() { // from class: com.google.appinventor.components.runtime.GameClient.23
            public void onSuccess(JSONObject response) {
                GameClient.this.processInstanceLists(response);
    ...
    public void postSetInstance(String instanceId) {
        postCommandToGameServer(JOIN_INSTANCE_COMMAND, Lists.newArrayList(new BasicNameValuePair(GAME_ID_KEY, GameId()), new BasicNameValuePair(INSTANCE_ID_KEY, instanceId), new BasicNameValuePair(PLAYER_ID_KEY, UserEmailAddress())), new AsyncCallbackPair<JSONObject>() { // from class: com.google.appinventor.components.runtime.GameClient.29
            public void onSuccess(JSONObject response) {
                GameClient.this.processInstanceLists(response);
                GameClient.this.FunctionCompleted("SetInstance");
            }
    ...
    private void postCommandToGameServer(final String commandName, final List<NameValuePair> params, final AsyncCallbackPair<JSONObject> callback, final boolean allowInstanceIdChange) {
        WebServiceUtil.getInstance().postCommandReturningObject(ServiceUrl(), commandName, params, new AsyncCallbackPair<JSONObject>() { // from class: com.google.appinventor.components.runtime.GameClient.32
