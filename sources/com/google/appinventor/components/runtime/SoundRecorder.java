    ...
    public void Start() {
        if (!this.havePermission) {
            this.form.runOnUiThread(new Runnable() { // from class: com.google.appinventor.components.runtime.SoundRecorder.1
                ...
                public void run() {
                    SoundRecorder.this.form.askPermission(new BulkPermissionRequest(me, "Start", "android.permission.RECORD_AUDIO", "android.permission.WRITE_EXTERNAL_STORAGE") { // from class: com.google.appinventor.components.runtime.SoundRecorder.1.1
