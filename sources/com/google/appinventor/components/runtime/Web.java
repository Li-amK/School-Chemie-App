...
public class Web extends AndroidNonvisibleComponent implements Component {
    ...
    public void performRequest(final CapturedProperties webProps, final byte[] postData, final String postFile, final String httpVerb, final String method) {
        ...
        if ((!this.havePermission) && this.saveResponse) {
            this.form.askPermission(new BulkPermissionRequest(this, LOG_TAG, new String[]{"android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE"}) { // from class: com.google.appinventor.components.runtime.Web.6
        ...
        try {
            ...
            this.form.dispatchPermissionDeniedEvent(this, method, e2);
            ...
            this.form.dispatchErrorOccurredEvent(this, method, e4.getErrorMessageNumber(), new Object[0]);
        } catch (Exception e5) {
