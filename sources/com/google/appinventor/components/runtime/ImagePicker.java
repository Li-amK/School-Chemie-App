...
public class ImagePicker extends Picker implements ActivityResultListener {
    ...
    private void saveSelectedImageToExternalStorage(String extension) {
        if (this.container.$form().isDeniedPermission("android.permission.WRITE_EXTERNAL_STORAGE")) {
            this.container.$form().dispatchPermissionDeniedEvent(this, LOG_TAG, "android.permission.WRITE_EXTERNAL_STORAGE");
            return;
        }
    ...
    private void trimDirectory(int maxSavedFiles2, File directory) {
        ...
        Arrays.sort(files, new Comparator<File>() { // from class: com.google.appinventor.components.runtime.ImagePicker.2
