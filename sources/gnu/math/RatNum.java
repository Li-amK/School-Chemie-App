...
public abstract class RatNum extends RealNum {
    ...
    private static RealNum simplest_rational2(RealNum x, RealNum y) {
        ...
        return !x.grt(fx) ? fx : fx.equals(fy) ? (RealNum) fx.add(IntNum.one().div(simplest_rational2((RealNum) IntNum.one().div(y.sub(fy)), (RealNum) IntNum.one().div(x.sub(fx)))), 1) : (RealNum) fx.add(IntNum.one(), 1);
    }
}
