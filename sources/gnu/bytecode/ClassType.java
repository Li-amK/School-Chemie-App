        ...
        for (Method method = getDeclaredMethods(); method != null; method = method.next) {
            if (name.equals(method.getName())) {
                ...
                if (i == method_args.length - needOuterLinkArg) {
                    while (true) {
                        i--;
                        if (i < 0 || !((meth_type = method_args[i + needOuterLinkArg]) == (need_type = arg_types[i]) || need_type == null || meth_type.getSignature().equals(need_type.getSignature()))) {
                            break;
                        }
                    }
                    if (i < 0) {
    ...
    */
    public synchronized gnu.bytecode.Method getMethod(java.lang.String r6, gnu.bytecode.Type[] r7) {
        /*
            ...
            r0 = r5
        L_0x0002:
            gnu.bytecode.Method r3 = r0.getDeclaredMethod(r6, r7)     // Catch: all -> 0x002e
            if (r3 == 0) goto L_0x000a
        L_0x0008:
            monitor-exit(r5)
            return r3
        L_0x000a:
            gnu.bytecode.ClassType r0 = r0.getSuperclass()     // Catch: all -> 0x002e
            if (r0 != 0) goto L_0x0002
            r0 = r5
        L_0x0011:
            gnu.bytecode.ClassType[] r2 = r0.getInterfaces()     // Catch: all -> 0x002e
            if (r2 == 0) goto L_0x0026
            r1 = 0
        L_0x0018:
            int r4 = r2.length     // Catch: all -> 0x002e
            if (r1 >= r4) goto L_0x0026
            r4 = r2[r1]     // Catch: all -> 0x002e
            gnu.bytecode.Method r3 = r4.getDeclaredMethod(r6, r7)     // Catch: all -> 0x002e
    ...
    public void doFixups() {
        ...
        if (this.superClassIndex < 0) {
            if (this.superClass == null) {
                ...
                i = this.constants.addClass(this.superClass).index;
            }
        ...
        for (int i3 = 1; i3 <= this.constants.count; i3++) {
            CpoolEntry entry = this.constants.pool[i3];
