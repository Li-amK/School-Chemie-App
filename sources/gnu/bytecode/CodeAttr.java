...
public class CodeAttr extends Attribute implements AttrContainer {
    ...
    public void emitTryStart(boolean has_finally, Type result_type) {
        ...
        if (this.local_types == null) {
            ...
            usedLocals = this.local_types.length;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:186:0x0245 A[SYNTHETIC] */
    ...
    */
    ...
    public void disAssemble(ClassTypeWriter dst, int start, int limit) {
        ...
        while (i5 < limit) {
            int i6 = i5 + 1;
            int op3 = this.code[i5] & Ev3Constants.Opcode.TST;
            ...
            if (op3 < 120) {
                if (op3 < 87) {
                    if (op3 < 3) {
                        ...
                        if (index3 >= 0) {
                            ...
                            if (wide) {
                                index4 = readUnsignedShort(i6);
                                i6 += 2;
                            } else {
                                index4 = this.code[i6] & Ev3Constants.Opcode.TST;
                                i6++;
                            }
                            wide = false;
                            dst.print(' ');
                        ...
                        if (op3 == 16) {
                            ...
                            i4 = i6 + 2;
                            constant2 = (short) readUnsignedShort(i6);
                        }
                        dst.print(constant2 == 1 ? 1 : 0);
                        i = i4;
                    } else {
                ...
                if (op3 < 132) {
                    ...
                    if (!wide) {
                        int i7 = i6 + 1;
                        var_index = this.code[i6] & Ev3Constants.Opcode.TST;
                        i3 = i7 + 1;
                        constant = this.code[i7];
                    } else {
                        var_index = readUnsignedShort(i6);
                        int i8 = i6 + 2;
                        i3 = i8 + 2;
                        wide = false;
                        constant = (short) readUnsignedShort(i8);
                    }
                    dst.print(' ');
                    dst.print(var_index);
                    dst.print(' ');
                    dst.print(constant == 1 ? 1 : 0);
                    i = i3;
                } else if (op3 < 148) {
                    ...
                    dst.print(' ');
                    dst.print(i5 + ((short) readUnsignedShort(i6)));
                    i = i6 + 2;
                } else {
                    dst.print("ret ");
                    if (wide) {
                        index = readUnsignedShort(i6) + 2;
                    } else {
                        index = this.code[i6] & Ev3Constants.Opcode.TST;
                        i6++;
                    }
                    wide = false;
                    dst.print(index);
                ...
                if (op3 != 170) {
                    ...
                    while (true) {
                        ...
                        int i10 = i2 + 4;
                        int code_offset2 = readInt(i10);
                        i2 = i10 + 4;
                        dst.println();
                        dst.print("  ");
                        dst.print(match);
                        dst.print(": ");
                        dst.print(i5 + code_offset2);
                    }
                } else {
                ...
                int index5 = readUnsignedShort(i6);
                int i12 = i6 + 2;
                dst.print((this.code[i12] & Ev3Constants.Opcode.TST) + " args)");
                ...
                if (op3 == 187 || op3 == 189 || op3 == 192 || op3 == 193) {
                    ...
                    if (op3 == 188) {
                        i = i6 + 1;
                        byte b2 = this.code[i6];
                        dst.print(' ');
                        if (b2 < 4 || b2 > 11) {
                            dst.print((int) b2);
                        } else {
                            print("boolean;char;float;double;byte;short;int;long;", b2 - 4, dst);
                        }
                    }
                    i = i6;
                }
                ...
                int index6 = readUnsignedShort(i6);
                int i13 = i6 + 2;
                dst.printConstantOperand(index6);
                i = i13 + 1;
                int dims = this.code[i13] & Ev3Constants.Opcode.TST;
                dst.print(' ');
                dst.print(dims);
            } else if (op3 < 200) {
