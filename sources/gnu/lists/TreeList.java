...
public class TreeList extends AbstractSequence implements Appendable, XConsumer, PositionConsumer, Consumable {
    ...
    */
                ...
                if (datum <= 40959) {
                    ...
                    switch (datum) {
                        ...
                        case 61711:
                            ...
                            sbuf.append(((AbstractSequence) this.objects[getIntN(pos2)]).getIteratorAtPos(getIntN(pos2 + 2)));
                            pos = pos2 + 4;
                            continue;
                        case BEGIN_DOCUMENT /* 61712 */:
                        ...
                        case PROCESSING_INSTRUCTION /* 61716 */:
                            ...
                            int pos4 = pos2 + 2;
                            sbuf.append(this.objects[getIntN(pos2)]);
                            int index6 = getIntN(pos4);
                            pos = pos4 + 2;
                            if (index6 > 0) {
                                sbuf.append(' ');
                                sbuf.append(this.data, pos, index6);
                                pos += index6;
                            }
                            sbuf.append("?>");
                            continue;
                        case CDATA_SECTION /* 61717 */:
                            ...
                            int index7 = getIntN(pos2);
                            int pos5 = pos2 + 2;
                            sbuf.append("<![CDATA[");
                            sbuf.append(this.data, pos5, index7);
                            sbuf.append("]]>");
                            pos = pos5 + index7;
                            continue;
                        case JOINER /* 61718 */:
                        ...
                        case COMMENT /* 61719 */:
                            ...
                            int pos6 = pos2 + 2;
                            sbuf.append("<!--");
                            sbuf.append(this.data, pos6, index8);
                            sbuf.append("-->");
                            pos = pos6 + index8;
                            continue;
    ...
    /* JADX WARN: Removed duplicated region for block: B:111:0x0072 A[ADDED_TO_REGION, SYNTHETIC] */
