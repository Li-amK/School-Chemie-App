...
public class XslTranslator extends Lexer implements Consumer {
    ...
    public void endElement() {
        ...
        String xslTag = isXslTag(this.comp.exprStack.elementAt(start));
        if (xslTag == "value-of") {
            ...
            Expression[] args = {new QuoteExp(popMatchingAttribute("", "select", start + 1)), resolveQNameExpression(popMatchingAttribute("", "mode", start + 1))};
            this.comp.exprStack.pop();
