...
public class pregexp extends ModuleBody {
    ...
    */
    ...
    /* JADX INFO: Multiple debug info for r7v1 int: [D('x' java.lang.Object), D('x' boolean)] */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00b3, code lost:
        if (kawa.lib.characters.isChar$Eq(gnu.text.Char.make(kawa.lib.strings.stringRef(r12, ((java.lang.Number) r7).intValue())), gnu.kawa.slib.pregexp.Lit46) != false) goto L_0x00b5;
     */
    ...
    */
                        ...
                        if (Scheme.isEqv.apply2(Char.make(tmp), Lit54) != Boolean.FALSE) {
                            try {
                                ...
                                try {
                                    ...
                                    if (Scheme.isEqv.apply2(Char.make(tmp2), Lit48) != Boolean.FALSE) {
                                        pregexpError$V = Lit55;
                                    } else {
                                        pregexpError$V = Scheme.isEqv.apply2(Char.make(tmp2), Lit50) != Boolean.FALSE ? Lit56 : pregexpError$V(new Object[]{Lit57});
                                    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:8:0x004e, code lost:
        if (kawa.lib.characters.isChar$Eq(gnu.text.Char.make(kawa.lib.strings.stringRef((java.lang.CharSequence) r15, ((java.lang.Number) r7).intValue())), gnu.kawa.slib.pregexp.Lit6) != false) goto L_0x0050;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    /* JADX INFO: Multiple debug info for r7v1 java.lang.Object: [D('x' boolean), D('x' java.lang.Object)] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:113:0x0113 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    /* JADX INFO: Multiple debug info for r5v4 int: [D('x' java.lang.Object), D('x' boolean)] */
    ...
    public class frame extends ModuleBody {
        ...
        /* JADX INFO: Multiple debug info for r14v5 java.lang.Object: [D('x' boolean), D('x' java.lang.Object)] */
         ...
         */
        /* JADX WARN: Code restructure failed: missing block: B:160:0x0517, code lost:
         ...
         */
        /* JADX WARN: Code restructure failed: missing block: B:198:0x0614, code lost:
            r1 = move-exception;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:201:0x061e, code lost:
            r2 = move-exception;
         */
        /* JADX WARN: Code restructure failed: missing block: B:203:0x0627, code lost:
            throw new gnu.mapping.WrongType(r2, "string-ref", 1, r1);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:210:0x063c, code lost:
            r1 = move-exception;
         */
        /* JADX WARN: Code restructure failed: missing block: B:212:0x0645, code lost:
            throw new gnu.mapping.WrongType(r1, "substring", 2, r3);
         */
        /* JADX WARN: Code restructure failed: missing block: B:213:0x0646, code lost:
            r1 = move-exception;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:219:0x065a, code lost:
            r2 = move-exception;
         */
        /* JADX WARN: Code restructure failed: missing block: B:221:0x0663, code lost:
    ...
    /* JADX INFO: Multiple debug info for r9v1 java.lang.Boolean: [D('x' boolean), D('x' java.lang.Object)] */
    /* JADX INFO: Multiple debug info for r9v2 java.lang.Boolean: [D('x' boolean), D('x' java.lang.Object)] */
    /* JADX INFO: Multiple debug info for r9v3 java.lang.Object: [D('x' boolean), D('x' java.lang.Object)] */
                ...
                try {
                    try {
                        ...
                        if (lists.memv(Char.make(c), Lit116) != Boolean.FALSE) {
                            r = lists.cons(Lit19, lists.cons(Char.make(c), lList));
                        } else {
                            r = lists.cons(Char.make(c), lList);
                        }
                        lList = r;
                        valueOf = i;
                    } catch (ClassCastException e) {
