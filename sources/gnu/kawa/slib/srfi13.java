...
public class srfi13 extends ModuleBody {
    ...
    static {
        ...
        string$Mnfold$Mnright = new ModuleMethod(srfi13Var, YaVersion.YOUNG_ANDROID_VERSION, Lit58, -4093);
    ...
    */
    ...
    public static Object $PcStringMap(Object proc, Object s, Object start, Object end) {
        ...
        try {
            ...
            for (Object apply2 = AddOp.$Mn.apply2(len, Lit1); Scheme.numLss.apply2(apply2, Lit0) == Boolean.FALSE; apply2 = AddOp.$Mn.apply2(apply2, Lit1)) {
                try {
    ...
    public class frame5 extends ModuleBody {
        ...
        Object lambda14(Object start, Object end) {
            Object v = this.knil;
            for (Object obj = start; Scheme.numLss.apply2(obj, end) != Boolean.FALSE; obj = AddOp.$Pl.apply2(obj, srfi13.Lit1)) {
    ...
    public class frame6 extends ModuleBody {
        ...
        Object lambda16(Object start, Object end) {
            Object v = this.knil;
            for (Object apply2 = AddOp.$Mn.apply2(end, srfi13.Lit1); Scheme.numGEq.apply2(apply2, start) != Boolean.FALSE; apply2 = AddOp.$Mn.apply2(apply2, srfi13.Lit1)) {
                ApplyToArgs applyToArgs = Scheme.applyToArgs;
                                                        ...
                                                        try {
                                                            try {
                                                                ...
                                                                while (lists.isPair(obj4)) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            throw new WrongType(e9, "%string-copy!", 1, j);
                                                                        }
                                                                    } catch (ClassCastException e10) {
                                                                ...
                                                                try {
                                                                    ...
                                                                    throw new WrongType(e13, "%string-copy!", 1, j);
                                                                }
                                                            } catch (ClassCastException e14) {
    ...
    public class frame9 extends ModuleBody {
        ...
        /* JADX INFO: Multiple debug info for r4v3 java.lang.Object: [D('x' boolean), D('x' java.lang.Object)] */
    ...
    public class frame10 extends ModuleBody {
        ...
        /* JADX INFO: Multiple debug info for r4v5 java.lang.Object: [D('x' java.lang.Object), D('x' boolean)] */
        /* JADX INFO: Multiple debug info for r4v9 java.lang.Object: [D('x' boolean), D('x' java.lang.Object)] */
    ...
    public static Object stringFill$Ex$V(Object s, Object obj, Object[] argsArray) {
        ...
        frame82Var.s = s;
        frame82Var.f7char = obj;
        frame82Var.maybe$Mnstart$Plend = LList.makeList(argsArray, 0);
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), characters.char$Qu, frame82Var.f7char, string$Mnfill$Ex);
    ...
    public static Object $PcKmpSearch(Object pattern, Object text, Object c$Eq, Object p$Mnstart, Object p$Mnend, Object t$Mnstart, Object t$Mnend) {
        ...
        Object ti = t$Mnstart;
        Object obj = plen;
        while (Scheme.numEqu.apply2(pi, plen) == Boolean.FALSE) {
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            Object apply23 = AddOp.$Pl.apply2(p$Mnstart, pi);
                            try {
                                if (applyToArgs.apply3(c$Eq, make, Char.make(strings.stringRef(charSequence, ((Number) apply23).intValue()))) != Boolean.FALSE) {
                                    ...
                                    pi = AddOp.$Pl.apply2(Lit1, pi);
                                    apply2 = AddOp.$Mn.apply2(apply2, Lit1);
                                    obj = AddOp.$Mn.apply2(obj, Lit1);
                                } else {
                                    try {
                                        try {
                                            pi = vectors.vectorRef((FVector) rv, pi.intValue());
                                            ...
                                            throw new WrongType(e, "vector-ref", 2, pi);
                                        }
                                    } catch (ClassCastException e2) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x00ec, code lost:
        r15 = gnu.kawa.functions.AddOp.$Pl.apply2(r8, gnu.kawa.slib.srfi13.Lit1);
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x0114, code lost:
        if (r21.apply3(r22, gnu.text.Char.make(kawa.lib.strings.stringRef(r13, ((java.lang.Number) r15).intValue())), gnu.text.Char.make(r3)) != java.lang.Boolean.FALSE) goto L_0x0123;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:44:0x0123, code lost:
        ...
        r8 = gnu.kawa.functions.AddOp.$Pl.apply2(r8, gnu.kawa.slib.srfi13.Lit1);
        r4 = r5;
     */
    ...
    */
    ...
    public class frame89 extends ModuleBody {
        ...
        CharSequence lambda201(Object start, Object end) {
            ...
            try {
                CharSequence ans = strings.makeString(((Number) len).intValue());
                Object i = start;
                for (Object apply2 = AddOp.$Mn.apply2(len, srfi13.Lit1); Scheme.numLss.apply2(apply2, srfi13.Lit0) == Boolean.FALSE; apply2 = AddOp.$Mn.apply2(apply2, srfi13.Lit1)) {
                    try {
                        CharSeq charSeq = (CharSeq) ans;
                        try {
                            int intValue = ((Number) apply2).intValue();
    ...
    public class frame90 extends ModuleBody {
        ...
        Object lambda203(Object start, Object end) {
            Object i = AddOp.$Mn.apply2(end, srfi13.Lit1);
            for (Object obj = start; Scheme.numLEq.apply2(i, obj) == Boolean.FALSE; obj = AddOp.$Pl.apply2(obj, srfi13.Lit1)) {
                Object obj2 = this.s;
                try {
                    try {
                        ...
                        try {
                            ...
                            try {
                                try {
                                    ...
                                    intNum = AddOp.$Pl.apply2(intNum, Integer.valueOf(slen2));
                                } catch (ClassCastException e2) {
                        ...
                        try {
                            try {
                                ...
                                try {
                                    ...
                                    Object obj6 = Lit0;
                                    for (Object obj7 = string$Mnlist; lists.isPair(obj7); obj7 = lists.cdr.apply1(obj7)) {
                                        AddOp addOp = AddOp.$Pl;
                                        Object apply1 = lists.car.apply1(obj7);
                                        try {
                                            obj6 = addOp.apply2(obj6, Integer.valueOf(strings.stringLength((CharSequence) apply1)));
                                        } catch (ClassCastException e5) {
                                    ...
                                    try {
                                        try {
                                            return applyToArgs.apply4(obj4, maybe$Mnfinal$Plend, apply2, $PcFinishStringConcatenateReverse(obj6, string$Mnlist, loc$final.get(), loc$end.get()));
                                        } catch (UnboundLocationException e6) {
                ...
                try {
                    try {
                        try {
                            ...
                            for (Object nspans = DivideOp.quotient.apply2(AddOp.$Mn.apply2(total$Mnchars, ncopied), slen); !numbers.isZero((Number) nspans); nspans = AddOp.$Mn.apply2(nspans, Lit1)) {
                                try {
                                    try {
                                        try {
                                            try {
