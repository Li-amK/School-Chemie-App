...
public class testing extends ModuleBody {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x003f, code lost:
        if ($PcTestAnySpecifierMatches(((gnu.kawa.slib.test$Mnrunner) r8).skip$Mnlist, r8) == java.lang.Boolean.FALSE) goto L_0x0041;
     */
    /* JADX WARN: Code restructure failed: missing block: B:24:0x004f, code lost:
        if ($PcTestAnySpecifierMatches(((gnu.kawa.slib.test$Mnrunner) r8).fail$Mnlist, r8) == java.lang.Boolean.FALSE) goto L_0x005b;
     */
    ...
    */
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        Object group$Mncount = AddOp.$Mn.apply2(((test$Mnrunner) r).total$Mncount, lists.caar.apply1(count$Mnlist));
    ...
    public static Object testReadEvalString(Object string) {
        try {
            ...
            return ports.isEofObject(readchar.readChar.apply1(port)) ? Eval.eval.apply1(ports.read(port)) : misc.error$V("(not at eof)", new Object[0]);
        } catch (ClassCastException e) {
