...
public class srfi1 extends ModuleBody {
    ...
    public static final ModuleMethod f6break;
    ...
    static {
        ...
        f6break = new ModuleMethod(srfi1Var, 164, Lit80, 8194);
    ...
    /* JADX INFO: Multiple debug info for r5v4 java.lang.Object: [D('x' boolean), D('x' java.lang.Object)] */
    public static Object list$Eq$V(Object $Eq, Object[] argsArray) {
        ...
        while (true) {
            ...
            if (list$Mna == list$Mnb) {
                ...
                while (isNullList(list$Mna) == Boolean.FALSE) {
                    Object isNullList = isNullList(list$Mnb);
                    try {
                        int i = ((isNullList != Boolean.FALSE ? 1 : 0) + 1) & 1;
                        if (i == 0) {
                            return i != 0 ? Boolean.TRUE : Boolean.FALSE;
                        }
                        Object x3 = Scheme.applyToArgs.apply3($Eq, lists.car.apply1(list$Mna), lists.car.apply1(list$Mnb));
                        if (x3 == Boolean.FALSE) {
                            return x3;
                        }
                        list$Mna = lists.cdr.apply1(list$Mna);
                        list$Mnb = lists.cdr.apply1(list$Mnb);
                    } catch (ClassCastException e) {
                        throw new WrongType(e, "x", -2, isNullList);
                    }
                }
                Object x4 = isNullList(list$Mnb);
                if (x4 == Boolean.FALSE) {
                    return x4;
                }
                list$Mna = list$Mnb;
    ...
    */
    ...
    public static Object fold$V(Procedure kons, Object knil, Object lis1, Object[] argsArray) {
        ...
        while (isNullList(lis) == Boolean.FALSE) {
            Object lis2 = lists.cdr.apply1(lis);
            knil = frame7Var.kons.apply2(lists.car.apply1(lis), knil);
            lis = lis2;
        }
        return knil;
    }
    ...
    /* JADX INFO: Multiple debug info for r10v1 'lis'  java.lang.Object: [D('lis' java.lang.Object), D('in' java.lang.Object)] */
    ...
    public static Object takeWhile$Ex(Procedure pred, Object lis) {
        ...
        Object prev = lis;
        for (Object prev2 = lists.cdr.apply1(lis); lists.isPair(prev2); prev2 = lists.cdr.apply1(prev2)) {
            if (pred.apply1(lists.car.apply1(prev2)) != Boolean.FALSE) {
                prev = prev2;
            } else {
                try {
                    ((Pair) prev).setCdr(LList.Empty);
    ...
    /* renamed from: break  reason: not valid java name */
    public static Object m1break(Object pred, Object lis) {
    ...
    public class frame26 extends ModuleBody {
        ...
        /* JADX INFO: Multiple debug info for r3v1 java.lang.Boolean: [D('x' boolean), D('x' java.lang.Object)] */
        /* JADX INFO: Multiple debug info for r3v2 java.lang.Boolean: [D('x' boolean), D('x' java.lang.Object)] */
    ...
    public static Object lset$Ls$Eq$V(Procedure $Eq, Object[] argsArray) {
        ...
        while (true) {
            ...
            apply1 = lists.cdr.apply1(apply1);
            boolean x = s2 == s1;
            Object x2 = x ? x ? Boolean.TRUE : Boolean.FALSE : $PcLset2$Ls$Eq($Eq, s1, s2);
            if (x2 == Boolean.FALSE) {
                return x2;
            }
            s1 = s2;
    ...
    /* JADX INFO: Multiple debug info for r4v4 java.lang.Object: [D('x' boolean), D('x' java.lang.Object)] */
    ...
    public static Object lsetAdjoin$V(Procedure $Eq, Object lis, Object[] argsArray) {
        ...
        frame32Var.$Eq = $Eq;
        return fold$V(frame32Var.lambda$Fn30, lis, LList.makeList(argsArray, 0), new Object[0]);
    }
    ...
    public static Object lsetUnion$V(Procedure $Eq, Object[] argsArray) {
        ...
        frame33Var.$Eq = $Eq;
        return reduce(frame33Var.lambda$Fn31, LList.Empty, LList.makeList(argsArray, 0));
    }
    ...
    public static Object lsetUnion$Ex$V(Procedure $Eq, Object[] argsArray) {
        ...
        frame35Var.$Eq = $Eq;
        return reduce(frame35Var.lambda$Fn34, LList.Empty, LList.makeList(argsArray, 0));
    }
    ...
    public static Object lsetIntersection$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        frame37Var.$Eq = $Eq;
        frame37Var.lists = delete(lis1, LList.makeList(argsArray, 0), Scheme.isEq);
    ...
    public static Object lsetIntersection$Ex$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        frame39Var.$Eq = $Eq;
        frame39Var.lists = delete(lis1, LList.makeList(argsArray, 0), Scheme.isEq);
    ...
    public static Object lsetDifference$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        frame41Var.$Eq = $Eq;
        frame41Var.lists = filter(lists.pair$Qu, LList.makeList(argsArray, 0));
    ...
    public static Object lsetDifference$Ex$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        frame43Var.$Eq = $Eq;
        frame43Var.lists = filter(lists.pair$Qu, LList.makeList(argsArray, 0));
    ...
    public static Object lsetXor$V(Procedure $Eq, Object[] argsArray) {
        ...
        frame45Var.$Eq = $Eq;
        return reduce(frame45Var.lambda$Fn45, LList.Empty, LList.makeList(argsArray, 0));
    }
    ...
    public static Object lsetXor$Ex$V(Procedure $Eq, Object[] argsArray) {
        ...
        frame48Var.$Eq = $Eq;
        return reduce(frame48Var.lambda$Fn49, LList.Empty, LList.makeList(argsArray, 0));
    }
    ...
    public class frame51 extends ModuleBody {
        ...
        boolean lambda70(Object elt) {
            ...
            frame52Var.elt = elt;
            if (srfi1.any$V(frame52Var.lambda$Fn54, this.lists, new Object[0]) != Boolean.FALSE) {
                i = 1;
            }
            return (i + 1) & 1;
        }
    ...
    public class frame53 extends ModuleBody {
        ...
        boolean lambda72(Object elt) {
            ...
            frame54Var.elt = elt;
            if (srfi1.any$V(frame54Var.lambda$Fn56, this.lists, new Object[0]) != Boolean.FALSE) {
                i = 1;
            }
            return (i + 1) & 1;
        }
