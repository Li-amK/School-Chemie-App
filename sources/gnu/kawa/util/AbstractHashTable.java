...
public abstract class AbstractHashTable<Entry extends Map.Entry<K, V>, K, V> extends AbstractMap<K, V> {
    ...
    public V get(Object key, V defaultValue) {
        ...
        return node == null ? defaultValue : (V) node.getValue();
    }
    ...
    */
    protected void rehash() {
        /*
            r15 = this;
            Entry extends java.util.Map$Entry<K, V>[] r12 = r15.table
            int r11 = r12.length
            int r6 = r11 * 2
            java.util.Map$Entry[] r8 = r15.allocEntries(r6)
            int r7 = r6 + (-1)
            r15.table = r8
            r15.mask = r7
            r4 = r11
        L_0x0010:
            ...
            java.util.Map$Entry r14 = r15.getEntryNext(r0)
            if (r14 == 0) goto L_0x002b
            r13 = 0
        L_0x001f:
            r10 = r0
            java.util.Map$Entry r0 = r15.getEntryNext(r10)
            r15.setEntryNext(r10, r13)
            r13 = r10
        ...
        L_0x002c:
            ...
            java.util.Map$Entry r9 = r15.getEntryNext(r1)
            int r2 = r15.getEntryHashCode(r1)
            int r5 = r15.hashToIndex(r2)
            r3 = r8[r5]
            r15.setEntryNext(r1, r3)
            r8[r5] = r1
            r1 = r9
            goto L_0x002c
        L_0x0043:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gnu.kawa.util.AbstractHashTable.rehash():void");
    }
