...
public class CompileMisc implements Inlineable {
    ...
    public static Expression validateApplyMap(ApplyExp exp, InlineCalls visitor, Type required, Procedure xproc) {
        ...
        LetExp let1 = new LetExp(new Expression[]{proc});
        ...
        while (true) {
            ...
            lexp.body = new IfExp(visitor.visitApplyOnly(new ApplyExp(mproc.isEq, new ReferenceExp(largs[i3]), empty), null), collect ? new ReferenceExp(resultDecl) : QuoteExp.voidExp, lexp.body);
