    ...
    */
    public synchronized void add(gnu.mapping.MethodProc r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            int r2 = r7.count     // Catch: all -> 0x0027
            r7.addAtEnd(r8)     // Catch: all -> 0x0027
            r1 = 0
        L_0x0007:
            if (r1 >= r2) goto L_0x0022
            gnu.mapping.MethodProc[] r3 = r7.methods     // Catch: all -> 0x0027
            r3 = r3[r1]     // Catch: all -> 0x0027
            gnu.mapping.MethodProc r0 = gnu.mapping.MethodProc.mostSpecific(r8, r3)     // Catch: all -> 0x0027
            if (r0 != r8) goto L_0x0024
            gnu.mapping.MethodProc[] r3 = r7.methods     // Catch: all -> 0x0027
            gnu.mapping.MethodProc[] r4 = r7.methods     // Catch: all -> 0x0027
            int r5 = r1 + 1
            int r6 = r2 - r1
            java.lang.System.arraycopy(r3, r1, r4, r5, r6)     // Catch: all -> 0x0027
            gnu.mapping.MethodProc[] r3 = r7.methods     // Catch: all -> 0x0027
            r3[r1] = r8     // Catch: all -> 0x0027
        L_0x0022:
            monitor-exit(r7)
            return
        L_0x0024:
