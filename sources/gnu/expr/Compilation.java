...
public class Compilation implements SourceLocator {
    ...
    public static final Method getConstructor(ClassType clas, LambdaExp lexp) {
        ...
        return clas.addMethod("<init>", 1, (!(lexp instanceof ClassExp) || lexp.staticLinkField == null) ? apply0args : new Type[]{lexp.staticLinkField.getType()}, Type.voidType);
    }
    ...
    */
        ...
        if (numApplyMethods != 0) {
            ...
            for (int j = 0; j < numApplyMethods; j++) {
                ...
                while (i < numMethods) {
                    ...
                    Method primMethod = primMethods[i];
                    Type[] primArgTypes = primMethod.getParameterTypes();
                    int singleArgs = source.min_args + i;
    ...
    public void process(int wantedState) {
        ...
        try {
            ...
            int i3 = 6;
            int i4 = 100;
            saveCompilation = setSaveCurrent(this);
    ...
    void generateBytecode() {
        ...
        if (this.minfo != null && this.minfo.getNamespaceUri() != null) {
            ...
            this.method = mapClass.addMethod("register", new Type[]{typeModuleManager}, Type.voidType, 1);
    ...
    public void loopStart() {
        ...
        let.addDeclaration("%do%loop").noteValue(loopLambda);
