...
public class ProcInitializer extends Initializer {
    ...
    public static void emitLoadModuleMethod(LambdaExp proc, Compilation comp) {
        ...
        if (!(!comp.immediate || pname == null || pdecl == null)) {
            Object old = Environment.getCurrent().get(pname instanceof Symbol ? (Symbol) pname : Symbol.make("", pname.toString().intern()), comp.getLanguage().getEnvPropertyFor(proc.nameDecl), null);
