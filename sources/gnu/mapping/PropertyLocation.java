...
public class PropertyLocation extends Location {
    ...
    /* JADX INFO: Multiple debug info for r3v1 java.lang.Object: [D('plist' gnu.lists.Pair), D('plist' java.lang.Object)] */
    public static void putProperty(Object symbol, Object property, Object newValue, Environment env) {
        ...
        Pair pair = new Pair(newValue, lloc2.get(LList.Empty));
        lloc2.set(new Pair(property, pair));
