...
public class NodeUtils {
    ...
    /* JADX INFO: Multiple debug info for r8v4 'rvalue'  java.lang.Object: [D('rvalue' gnu.mapping.MethodProc), D('rvalue' java.lang.Object)] */
    public static Object collection(Object uri, Object base) throws Throwable {
        ...
        if (((rvalue instanceof String) || (rvalue instanceof UntypedAtomic)) && (colon = (str = rvalue.toString()).indexOf(58)) > 0) {
            ...
            try {
                rvalue = ClassMethods.apply((ClassType) ClassType.make(Class.forName(cname)), mname, (char) 0, XQuery.instance);
                if (rvalue == null) {
