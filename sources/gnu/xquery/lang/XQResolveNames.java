...
public class XQResolveNames extends ResolveNames {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00fc, code lost:
        if (r12 != false) goto L_0x0100;
     */
    /* JADX WARN: Code restructure failed: missing block: B:44:0x00fe, code lost:
        if (r13 == false) goto L_0x0029;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x0110, code lost:
        if (gnu.xquery.lang.XQuery.SCHEMA_NAMESPACE.equals(r17) == false) goto L_0x013b;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x013b, code lost:
        if (r13 == false) goto L_0x011a;
     */
    /* JADX WARN: Code restructure failed: missing block: B:55:0x0143, code lost:
        if (r17 != "") goto L_0x011a;
     */
    /* JADX WARN: Code restructure failed: missing block: B:57:0x014d, code lost:
        if (getCompilation().isPedantic() != false) goto L_0x011a;
     */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x014f, code lost:
        r16 = kawa.standard.Scheme.string2Type(r14.getName());
     */
    /* JADX WARN: Code restructure failed: missing block: B:59:0x0158, code lost:
        if (r17 == null) goto L_0x0184;
     */
    /* JADX WARN: Code restructure failed: missing block: B:61:0x0164, code lost:
        if (r17.length() <= 6) goto L_0x0184;
     */
    /* JADX WARN: Code restructure failed: missing block: B:63:0x016c, code lost:
        if (r17.startsWith("class:") == false) goto L_0x0184;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:?, code lost:
        return gnu.kawa.functions.CompileNamedPart.makeExp(gnu.bytecode.ClassType.make(r17.substring(6)), r14.getName());
     */
    /*
    ...
    */
    ...
    /* JADX INFO: Multiple debug info for r50v1 java.lang.String: [D('val' java.lang.Object), D('val' java.lang.String)] */
            ...
            switch (code) {
                ...
                case XS_QNAME_BUILTIN /* -35 */:
                    ...
                    if (args[0] instanceof QuoteExp) {
                        ...
                        ApplyExp app = new ApplyExp(ClassType.make("gnu.xquery.util.QNameUtils").getDeclaredMethod("resolveQName", 3), args[0], new QuoteExp(constructorNamespaces), new QuoteExp(this.parser.prologNamespaces));
                        app.setFlag(4);
                        return app;
                    }
                ...
                case RESOLVE_PREFIX_BUILTIN /* -13 */:
                    ...
                    ApplyExp app2 = new ApplyExp(new PrimProcedure(ClassType.make("gnu.xquery.util.QNameUtils").getDeclaredMethod("resolvePrefix", 3)), args4[0], new QuoteExp(this.parser.constructorNamespaces), new QuoteExp(this.parser.prologNamespaces));
                    app2.setFlag(4);
                    return app2;
