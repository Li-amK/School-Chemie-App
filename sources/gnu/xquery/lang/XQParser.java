...
public class XQParser extends Lexer {
    ...
    NamespaceBinding prologNamespaces = builtinNamespaces;
    ...
    */
    ...
    public Expression parseDataType() throws IOException, SyntaxException {
        ...
        getRawToken();
        ApplyExp otype = new ApplyExp(proc_OccurrenceType_getInstance, etype, QuoteExp.getInstance(IntNum.make(min)), QuoteExp.getInstance(IntNum.make(max)));
        otype.setFlag(4);
        return otype;
    }
    ...
    public Expression parseItemType() throws IOException, SyntaxException {
        ...
        if (etype != null) {
            ...
            ReferenceExp rexp = new ReferenceExp(new String(this.tokenBuffer, 0, this.tokenBufferLength));
            rexp.setFlag(16);
    ...
    */
    ...
    public Expression parseQuantifiedExpr(boolean isEvery) throws IOException, SyntaxException {
        ...
        this.comp.pop(lexp);
        lexp.body = body;
        return new ApplyExp(makeFunctionExp("gnu.xquery.util.ValuesEvery", isEvery ? "every" : "some"), lexp, inits[0]);
    }
