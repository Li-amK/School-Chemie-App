...
public class SyntaxPattern extends Pattern implements Externalizable {
    ...
    /* JADX INFO: Multiple debug info for r35v1 'pattern'  java.lang.Object: [D('pattern' java.lang.Object), D('syntax' kawa.lang.SyntaxForm)] */
        ...
        while (true) {
            if (pattern instanceof SyntaxForm) {
                ...
                try {
                    ...
                    translate(pair.getCar(), program, literal_identifiers, repeat ? nesting + 1 : nesting, literals, syntax, context == 'V' ? (char) 0 : 'P', tr);
