    ...
    public Object[] scanClassDef(Pair pair, ClassExp oexp, Translator tr) {
        ...
        while (obj2 != LList.Empty) {
            ...
            if ((pair_car2 instanceof String) || (pair_car2 instanceof Symbol) || (pair_car2 instanceof Keyword)) {
                ...
                long accessFlag = 0;
                if (pair_car2 instanceof Keyword) {
                    decl = null;
                    args = pair3;
                } else {
                    decl = oexp.addDeclaration(pair_car2);
                ...
                while (args != LList.Empty) {
                    ...
                    if ((key == coloncolon || (key instanceof Keyword)) && (args instanceof Pair)) {
                        ...
                        if (key == coloncolon || key == typeKeyword) {
                            ...
                            } else if (((Keyword) value).getName() != pair_car2.toString()) {
                ...
                if (args != LList.Empty) {
                    tr.error('e', "invalid argument list for slot '" + pair_car2 + "' args:" + (args == null ? "null" : args.getClass().getName()));
                    return null;
                }
                if (seenInit) {
