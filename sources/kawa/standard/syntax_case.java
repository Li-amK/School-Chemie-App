        ...
        try {
            if (clauses instanceof Pair) {
                ...
                if (clause instanceof Pair) {
                    ...
                    Expression tryMatch = new ApplyExp(new PrimProcedure(Pattern.matchPatternMethod, language), new QuoteExp(pattern), new ReferenceExp(work.inputExpression), new ReferenceExp(tr.matchArray), new QuoteExp(IntNum.zero()));
