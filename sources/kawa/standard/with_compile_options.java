...
public class with_compile_options extends Syntax {
    ...
    /* JADX INFO: Multiple debug info for r0v1 gnu.lists.LList: [D('rest' java.lang.Object), D('rest' gnu.lists.LList)] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:14:0x0041 A[Catch: all -> 0x004d, TRY_ENTER, TRY_LEAVE, TryCatch #0 {all -> 0x004d, blocks: (B:7:0x0022, B:9:0x002a, B:10:0x002e, B:14:0x0041), top: B:18:0x0022 }] */
    /* JADX WARN: Removed duplicated region for block: B:9:0x002a A[Catch: all -> 0x004d, TryCatch #0 {all -> 0x004d, blocks: (B:7:0x0022, B:9:0x002a, B:10:0x002e, B:14:0x0041), top: B:18:0x0022 }] */
    @Override // kawa.lang.Syntax
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
