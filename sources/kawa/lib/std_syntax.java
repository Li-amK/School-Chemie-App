...
public class std_syntax extends ModuleBody {
    ...
    public static final Macro f10case;
    ...
    public static final Macro f11do;
    ...
    static {
        ...
        f10case = Macro.make(Lit4, Lit5, $instance);
        ...
        f11do = Macro.make(Lit40, Lit41, $instance);
    ...
    public static Object generateTemporaries(Object list) {
        ...
        while (Scheme.numEqu.apply2(valueOf, Lit0) == Boolean.FALSE) {
            ...
            obj = new Pair(SyntaxForms.makeWithTemplate(list, Symbols.gentemp()), obj);
        }
        return obj;
    }
