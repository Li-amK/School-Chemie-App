...
public class syntax extends ModuleBody {
    ...
    public static final Macro f12import;
    ...
    public static final Macro f13synchronized;
    ...
    static {
        ...
        f13synchronized = Macro.make(Lit25, new ModuleMethod(syntaxVar, 3, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), $instance);
        ...
        f12import = Macro.make(Lit36, Lit37, $instance);
